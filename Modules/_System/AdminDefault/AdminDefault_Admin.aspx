<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Structure/WebAdmin/WebAdmin.master" CodeFile="AdminDefault_Admin.aspx.cs" Inherits="Modules__System_AdminDefault_AdminDefault_Admin" %>
...
<asp:Content ID="Content" ContentPlaceHolderId="MainAdminContent" runat="server">
    ...
    <div id="Page_1" runat="server" visible="false" class="Page_div">
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td class="Text12_gray">Author:&nbsp;</td>
            </tr>
            <tr>
                <td><asp:TextBox ID="txtMetaAuthor" class="form_textbox_600" runat="server" /></td>
            </tr>
            <tr>
                <td style="height:5px; font-size:1px;">&nbsp;</td>
            </tr> 
            <tr>
                <td class="Text12_gray">Copyright:&nbsp;</td>
            </tr>
            <tr>
                <td><asp:TextBox ID="txtMetaCopyright" class="form_textbox_600" runat="server" /></td>
            </tr>
         </table>     
        <br />
        <hr class='line' />    
