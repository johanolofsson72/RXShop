<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Structure/WebAdmin/WebAdmin.master" CodeFile="Category_Admin.aspx.cs" Inherits="Modules_Menus_Category_Category_Admin" %>
...
<asp:Content ID="Content" ContentPlaceHolderId="MainAdminContent" runat="server">
    ...
    <div id="Page_2" runat="server" visible="false" class="Page_div">
        ...
        <div style="position:relative; float: right;">
            <asp:Button ID="btnSaveHeader" runat="server" Text="Save & Close" class="form_button" onclick="btnSaveHeader_Click" />
        </div>
    </div>
