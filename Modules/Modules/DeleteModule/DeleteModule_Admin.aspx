<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Structure/WebAdmin/WebAdmin.master" CodeFile="DeleteModule_Admin.aspx.cs" Inherits="Modules_Modules_DeleteModule_DeleteModule_Admin" %>
...
<asp:Content ID="Content" ContentPlaceHolderId="MainAdminContent" runat="server">
    ...
    <div id="Page_1" runat="server" visible="false" class="Page_div">
        ...
        <table style="width: 100%; border: 0px;" cellpadding="0" cellspacing="5">
            <tr>
                <td class='Text12_gray'>Are you sure you want to remove this Module?</td>
            </tr>
        </table>        
        ...
        <hr class='line' />    
        <br />
        <asp:Button id="btnDeleteModule" runat="server" class="form_button" 
            Text="Delete Module" onclick="btnDeleteModule_Click" />
    </div> 
