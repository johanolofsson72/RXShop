<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Structure/WebAdmin/WebAdmin.master" CodeFile="Register_Admin.aspx.cs" Inherits="Modules_Boxes_TeaserBox_TeaserBox_Admin" %>
...
<asp:Content ID="Content" ContentPlaceHolderId="MainAdminContent" runat="server">
    ...
    <div id="Page_1" runat="server" visible="false" class="Page_div">
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td>
                    <uc1:InternalLink id="InternalLink" Visible="true" runat="server"></uc1:InternalLink></td>
                </td>            
            </tr>
        </table>
        <br />
