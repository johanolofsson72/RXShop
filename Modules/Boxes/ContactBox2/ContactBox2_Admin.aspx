<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Structure/WebAdmin/WebAdmin.master" CodeFile="ContactBox2_Admin.aspx.cs" Inherits="Modules_Boxes_ContactBox2_ContactBox2_Admin" %>
...
<%--    <div id="Page_1b" runat="server" visible="false" class="Page_div">
    ...
    <div id="Page_3" runat="server" visible="false" class="Page_div">
        ...
        <table cellpadding="0" cellspacing="0" style="">
            ...
            <tr>
                <td class="Text12_gray">Email:<asp:Image id="imgError3_2" runat="server" Visible="false" ImageUrl="~/App_Themes/WebAdmin/Images/icon_error_small.gif" ToolTip="Error"/></td>
            </tr>
            <tr>
                <td><asp:TextBox ID="txtCategoryEmail" class="form_textbox_bold_400" runat="server" /></td>
            </tr>
        </table>
