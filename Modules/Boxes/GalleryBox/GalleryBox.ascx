<%@ Control Language="C#" AutoEventWireup="true" CodeFile="GalleryBox.ascx.cs" Inherits="Modules_Boxes_GalleryBox_GalleryBox" %>
<%@ Register TagPrefix="telerik" Namespace="Telerik.Web.UI" Assembly="Telerik.Web.UI" %>

<div id="GalleryBox_holder" runat="server">
    <div id="GalleryBox_admin" runat="server" visible="false">
        <script type="text/javascript">
            //<![CDATA[
            
            function showAdminGalleryBox(SitId,PagId,ModId,Var)
            {
                var oWnd = $find("<%=RadWindow1_GalleryBox.ClientID%>");
                var d = new Date();oWnd.SetUrl("http://<% Response.Write(Request.Url.Authority + Request.ApplicationPath); %>/Modules/Boxes/GalleryBox/GalleryBox_Admin.aspx?SitId=1&PagId=" + PagId + "&ModId=" + ModId + "&Var=" + Var + "&UID=" + d.getMilliseconds());
                oWnd.show();  
            }
    ...
    <div id="GalleryBox"><asp:Literal id="ltrGallery" runat="server" /></div>
</div>