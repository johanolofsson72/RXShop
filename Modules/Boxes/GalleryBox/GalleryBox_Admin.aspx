<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Structure/WebAdmin/WebAdmin.master" CodeFile="GalleryBox_Admin.aspx.cs" Inherits="Modules_Boxes_Gallery_Gallery_Admin" %>
...
<%--            <tr>
    ...
    <div id="Page_3" runat="server" visible="false" class="Page_div">
        ...
        <hr class='line' />    
        <br />
        <telerik:RadProgressArea ID="RadProgressArea2" skin="Telerik" runat="server" />
