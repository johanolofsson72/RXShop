<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Structure/WebAdmin/WebAdmin.master" CodeFile="DeletePost_Admin.aspx.cs" Inherits="Modules_Boxes_Forum_DeletePost_DeletePost_Admin" %>
...
<asp:Content ID="Content" ContentPlaceHolderId="MainAdminContent" runat="server">
    ...
    <div id="Page_1" runat="server" visible="false" class="Page_div">
        ...
        <table style="width: 100%;" border="0" cellpadding="0" cellspacing="5">
            <tr>
                <td class='Text12_gray'>Are you sure you want to remove this post?</td>
            </tr>
        </table>        
        ...
        <hr class='line' />    
        <br />
        <asp:Button id="btnDeletePost" runat="server" class="form_button" 
            Text="Delete Post" onclick="btnDeletePost_Click" />
    </div> 
