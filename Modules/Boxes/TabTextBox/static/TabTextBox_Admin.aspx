...
<asp:Content ID="Content" ContentPlaceHolderId="MainAdminContent" runat="server">
    ...
    <div id="Page_3" runat="server" visible="false" class="Page_div">
        ...
        <table cellpadding="0" cellspacing="0" style="">
            <tr>
                <td class="Text12_gray"><asp:CheckBox id="cbShowTab" Checked="true" runat="server" />&nbsp;&nbsp;Visible</td>
            </tr>
            <tr>
                <td style="height:10px; font-size:1px;">&nbsp;</td>
            </tr>
            ...
            <tr>
                <td><asp:TextBox ID="txtTabname" class="form_textbox_bold_600" runat="server" /></td>
            </tr>
            <tr>
                <td style="height:10px; font-size:1px;">&nbsp;</td>
            </tr>
